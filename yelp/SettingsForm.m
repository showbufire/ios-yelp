...
- (NSDictionary *)distanceField
{
    return @{FXFormFieldOptions: @[@0, @1, @2, @3, @4],
...
{
    return @{FXFormFieldOptions: @[@0, @1, @2],
             FXFormFieldValueTransformer: ^(id input) {
                 return @{@0: @"Best matched",
                          @1: @"Distance",
                          @2: @"Highest Rated"}[input];
             }
    };
}
...
{
    return @{FXFormFieldOptions: [[self category2code] allKeys],
             FXFormFieldValueTransformer: ^(id input) {
                 return [self category2code][input];
             }
        
    };
}

- (NSDictionary *)category2code {
